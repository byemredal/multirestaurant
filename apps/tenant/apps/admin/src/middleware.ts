...
// redirects to the setup wizard at the request level — before any AdminShell /
// sidebar / login HTML is rendered — so an un-initialized platform never
// flickers the admin shell before the setup notice.
