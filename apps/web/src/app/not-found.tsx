...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-ink-50 p-6 text-center">
      <p className="text-[13px] font-semibold uppercase tracking-[0.18em] text-primary-700">
        404
      </p>
      ...
      <p className="mt-2 max-w-sm text-[14.5px] leading-relaxed text-ink-500">
        Aradığınız sayfa taşınmış ya da hiç var olmamış olabilir. Restoranları
        keşfetmeye ana sayfadan devam edebilirsiniz.
      </p>
      <Link
        href="/"
