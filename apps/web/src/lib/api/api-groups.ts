...
export const apiGroups: ApiGroup[] = [
  ...
  {
    id: 'adminComplianceCatalog',
    label: 'Admin - Onboarding Compliance Catalog (admin auth required)',
    actions: [
      {
        id: 'listComplianceDocumentRequirements',
        method: 'GET',
        path: '/admin/compliance-catalog/document-requirements',
      },
      {
        id: 'createComplianceDocumentRequirement',
        method: 'POST',
        path: '/admin/compliance-catalog/document-requirements',
        bodyFields: [
          { key: 'country', label: 'country (ISO-2, e.g. CH)' },
          { key: 'language', label: 'language (BCP-47, e.g. de-CH)' },
          { key: 'documentType', label: 'documentType' },
          { key: 'label', label: 'label' },
          { key: 'description', label: 'description' },
          { key: 'required', label: 'required (true/false)' },
          { key: 'acceptedFormats', label: 'acceptedFormats (JSON array)' },
          { key: 'guidanceOnly', label: 'guidanceOnly (true/false)' },
          { key: 'active', label: 'active (true/false)' },
          { key: 'sortOrder', label: 'sortOrder', type: 'number' },
        ],
      },
      {
        id: 'updateComplianceDocumentRequirement',
        method: 'PATCH',
        path: '/admin/compliance-catalog/document-requirements/:id',
        pathParams: [{ key: 'id', label: 'Requirement ID' }],
        bodyFields: [
          { key: 'label', label: 'label (optional)' },
          { key: 'description', label: 'description (optional)' },
          { key: 'required', label: 'required (optional true/false)' },
          { key: 'active', label: 'active (optional true/false)' },
          { key: 'sortOrder', label: 'sortOrder (optional)', type: 'number' },
        ],
      },
      {
        id: 'listComplianceConsentDefinitions',
        method: 'GET',
        path: '/admin/compliance-catalog/consent-definitions',
      },
      {
        id: 'createComplianceConsentDefinition',
        method: 'POST',
        path: '/admin/compliance-catalog/consent-definitions',
        bodyFields: [
          { key: 'country', label: 'country (ISO-2, e.g. CH)' },
          { key: 'language', label: 'language (BCP-47, e.g. de-CH)' },
          { key: 'consentKey', label: 'consentKey' },
          { key: 'label', label: 'label' },
          { key: 'description', label: 'description' },
          { key: 'documentCode', label: 'documentCode' },
          { key: 'documentVersion', label: 'documentVersion' },
          { key: 'documentUrl', label: 'documentUrl (optional)' },
          { key: 'required', label: 'required (true/false)' },
          { key: 'active', label: 'active (true/false)' },
          { key: 'sortOrder', label: 'sortOrder', type: 'number' },
        ],
      ...
      {
        id: 'updateComplianceConsentDefinition',
        method: 'PATCH',
        path: '/admin/compliance-catalog/consent-definitions/:id',
        pathParams: [{ key: 'id', label: 'Consent definition ID' }],
        bodyFields: [
          { key: 'label', label: 'label (optional)' },
          { key: 'description', label: 'description (optional)' },
          { key: 'documentVersion', label: 'documentVersion (optional)' },
          { key: 'documentUrl', label: 'documentUrl (optional)' },
          { key: 'required', label: 'required (optional true/false)' },
          { key: 'active', label: 'active (optional true/false)' },
          { key: 'sortOrder', label: 'sortOrder (optional)', type: 'number' },
